                ...
                while ( rs.hasNext() ) {
                     ...
                     try{
                             ...
                             if(verb!=null && e1_arg!=null && e2_arg!=null && preposition!=null) {
                                 ...
                                 Templates.getAdjective(model, lexicon, sentence, verb, e1_arg, e2_arg, preposition, this.getReference(model), logger, this.getLemmatizer(),Language.DE,getID(),exported_entries);
                                 updated_entry += 1;
                             }
                     }
                     catch(Exception e){
