                    ...
                    try{
                        ...
                        if(participle!=null && e1_arg!=null && e2_arg!=null) {
                            ...
                            {   if(preposition.equals("por")){
                                    Templates.getTransitiveVerb(model, lexicon, sentence, lemma, e2_arg, e1_arg, this.getReference(model), logger, this.getLemmatizer(),Language.ES,getID(),exported_entries);
                                    updated_entry += 1;
                                }
                            }
                            else{
