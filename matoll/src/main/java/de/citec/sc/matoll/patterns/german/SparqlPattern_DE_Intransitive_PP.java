                 ...
                 while ( rs.hasNext() ) {
                     ...
                     try{
                             ...
                             if(verb!=null && e1_arg!=null && e2_arg!=null && prep!=null) {
                                 ...
                                 if(particle!=null){
                                     Templates.getIntransitiveVerb(model, lexicon, sentence,particle+verb, e1_arg, e2_arg,prep, this.getReference(model), logger, this.getLemmatizer(),Language.DE,getID(),exported_entries);
                                     updated_entry += 1;
                                 }else{
                                     Templates.getIntransitiveVerb(model, lexicon, sentence,verb, e1_arg, e2_arg,prep, this.getReference(model), logger, this.getLemmatizer(),Language.DE,getID(),exported_entries);
                                     updated_entry += 1;
                                 }
                             }
                     }
