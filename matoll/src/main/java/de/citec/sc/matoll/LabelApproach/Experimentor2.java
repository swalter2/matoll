		...
		RandomForest classifier = new RandomForest();
                ...
                for(Set<String> combination : combinations_feature_new){
                    ...
                    if(!f.exists()) { 
                        ...
                        try {
                                GenerateArff.run_experimentator2(path_input, "resources/arff_combinations/"+feature_name+".arff",label_3,label_2,pos,posAdj,tagger,label_feature);
